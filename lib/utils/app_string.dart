class AppString {
  ...
  static const String onboardTileMainAttendDes ='Manage your daily attendance, keep track of your goal and easily request for a new log or changing the existing log data. ';
  static const String onboardTileEasyDes ='Apply leave at ease, keep track of the leave records and stay updated on the paid and unpaid leave balance.';
  static const String onboardTileReceivePayDes ='Receive your payslips, keep track of the payment data and stay updated on the payday details.';
