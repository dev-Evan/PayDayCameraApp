...
class InputTextFieldController extends GetxController {
 ...
 //Profile data update
  ...
  final TextEditingController addAreaController = TextEditingController();
  final TextEditingController addCityController = TextEditingController();
  final TextEditingController addCountyController = TextEditingController();
  final TextEditingController addDetailsController = TextEditingController();
  final TextEditingController addPhoneNumberController = TextEditingController();
  final TextEditingController addStateController = TextEditingController();
