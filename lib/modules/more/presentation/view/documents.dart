...
Widget _cardImgTitle({required titleText, required sizeText}) {
  return Container(
    decoration: AppStyle.ContainerStyle.copyWith(
        color: Colors.transparent,
        borderRadius: BorderRadius.only(
...
// },
// )),
// CustomButton(AppString.text_add_documents, () {
// customButtomSheet(
// context: context,
// height: 0.9,
// child: const AddDocument());
