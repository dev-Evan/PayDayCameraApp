...
Widget dateOfBirthField({required context}) {
  return TextFormField(
    ...
    readOnly: true,
    onTap: () => Get.find<DatePickerController>().dateOfBirth(context),
...
InputDecoration _inputDecoration(context) {
  return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderSide: const BorderSide(width: 1.0, color: AppColor.primaryColor),
        borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
      ),
      ...
      suffixIcon: IconButton(
        onPressed: () => Get.find<DatePickerController>().dateOfBirth(context),
