...
import 'package:pay_day_mobile/modules/more/presentation/widget/job_history_job_title.dart';
import 'package:pay_day_mobile/utils/app_layout.dart';

Widget jobHisEmploymentView() {
  return Padding(
    padding: const EdgeInsets.only(left: 46.0, bottom: 16, top: 0),
            ...
            Positioned(
                ...
                child: jodTitle(
                    jobTitleText: Get.find<JobHistoryController>()
                            .jobHistoryModel
                            .data
                            ?.employmentStatuses?[index]
                            .name ??
                        "",
                    subTitleText: Get.find<JobHistoryController>()
                            .jobHistoryModel
                            .data
                            ?.employmentStatuses?[index]
                            .startDate ??
                        "",
                    subEndText: Get.find<JobHistoryController>()
                            .jobHistoryModel
                            .data
                            ?.employmentStatuses?[index]
                            .endDate ??
