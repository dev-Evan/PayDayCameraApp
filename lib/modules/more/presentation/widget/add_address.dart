              ...
              Flexible(
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFeild(hintText: 'Enter city', controller:_areaController),
                  ],
                ),
              ),
            ],
              ...
              Flexible(
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFeild(hintText: 'Enter state', controller:_areaController),
                  ],
                ),
              ),
              SizedBox(width: AppLayout.getWidth(18),),
              Flexible(
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFeild(hintText: 'Enter zip code', controller:_areaController),
                  ],
                ),
              ),
            ],
