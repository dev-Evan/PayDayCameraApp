...
import 'package:pay_day_mobile/modules/leave/presentation/widget/custom_horizontal_calendar/scrollable_position_list.dart';
...
class _CustomCalendarTimelineState extends State<CustomCalendarTimeline> {
  ...
  @override
  void didUpdateWidget(CustomCalendarTimeline oldWidget) {
    ...
    return SizedBox(
      ...
      child: ScrollablePositionedList.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          final shortName = DateFormat.E(_locale).format(currentDay);
          return Row(
            children: <Widget>[
              DayItem(
